...
#[Route('/admin/matchs')]
final class MatchsControllerBack extends AbstractController
{
    #[Route(name: 'app_matchs_index_admin', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_matchs_new_admin', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_matchs_index_admin', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('matchs/admin/new.html.twig', [
            'match' => $match,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_matchs_show_admin', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_matchs_edit_admin', methods: ['GET', 'POST'])]
    public function edit(Request $request, Matchs $match, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('matchs/admin/edit.html.twig', [
            'match' => $match,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_matchs_delete_admin', methods: ['POST'])]
